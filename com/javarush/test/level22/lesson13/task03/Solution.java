...
public class Solution {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("(050)(123)-45-67 = " + checkTelNumber("(050)(123)-45-67"));
        */
    }

    public static boolean checkTelNumber(String telNumber) {
        return telNumber == null ? false :
                telNumber.matches("^\\+(\\D{0,2}\\d){12}|\\(?\\d(\\D{0,2}\\d){9}$") &&
                        telNumber.matches("^\\+?\\d*(\\(\\d{3}\\))?\\d*(-\\d+){0,2}$");
    }
}

/*
-3805012345-67 (need: true, have: false)
 */