    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                double profit1 = last1 - open1 != 0 ? last1 - open1 :
                        !stock1.containsKey("change") ? 0 : ((double) stock1.get("change"));
                double profit2 = last2 - open2 != 0 ? last2 - open2 :
                        !stock2.containsKey("change") ? 0 : ((double) stock2.get("change"));
