...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("str: " + classWithStatic.staticString + " and " + loadedObject.staticString + " = "
                                + classWithStatic.staticString.equals(loadedObject.staticString));
            System.out.println("i: " + classWithStatic.i + " and " + loadedObject.i + " = " + (classWithStatic.i == loadedObject.i));
            System.out.println("j: " + classWithStatic.j + " and " + loadedObject.j + " = " + (classWithStatic.j == loadedObject.j));
